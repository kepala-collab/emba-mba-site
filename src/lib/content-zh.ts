...
export const COMPARISON_ZH = [
  { k: "修读时间", them: "18–24 个月", us: "六个月：6 个培训日，分三个指定课程完成" },
  ...
  { k: "课程费用", them: "授予院校公布的学费及附加费用", us: "标准费用 RM10,000.00；LIFE Innoversity 奖学金名额有限，仅择优授予符合资格的马来西亚申请者，须经评估与书面批准，任何奖学金金额及应付费用均会个别以书面确认" },
...
export const CORE_PAGES_ZH = {
  ...
  programme: {
    ...
    title: "专为在职的资深管理者打造",
    intro: "六个月内完成 6 个培训日、导师辅导与一个企业项目，全程无需离岗，边工作边学。符合条件的学员，可另行咨询 Chartered Manager 的后续发展路径。",
    sections: [
      ["六个月课程安排", "完成 6 个培训日、三个集中课程、企业项目及辅导。达到课程要求后，学员取得获 CMI 认可的 Executive MBA 课程证书。"],
  ...
  curriculum: {
    ...
    sections: [
      ...
      ["12 个模块", MODULES_ZH.map((module) => `${module.c} ${module.title}——${module.outcome}`).join("；")],
  ...
  fees: {
    ...
    sections: [
      ...
      ["马来西亚申请者费用", "标准费用为 RM10,000.00。符合资格的马来西亚申请者可接受 LIFE Innoversity 奖学金择优评估。任何奖学金金额及应付费用会在评估后个别以书面确认；奖学金名额有限、须经择优评估，并非自动获得。"],
...
export const FAQS_ZH = [
  ["课程如何安排？", "课程为期六个月，包括 6 个培训日、三个周末课程、辅导与企业项目。达到课程要求后，学员取得获 CMI 认可的 Executive MBA 课程证书。Chartered Manager 是具有独立资格、评估及费用的可选 CMI 路线，不包含在本课程或已公布费用内。"],
