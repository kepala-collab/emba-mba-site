...
export const COMPARISON_ZH = [
  ...
  { k: "课程费用", them: "授予院校公布的学费及附加费用", us: "标准费用 RM10,000.00；符合资格的马来西亚申请者经评估及书面批准后，可获 RM5,000.00 LIFE Innoversity 奖学金" },
...
export const CORE_PAGES_ZH = {
  ...
  fees: {
    ...
    title: "标准费用 RM10,000.00；符合资格者可申请 RM5,000.00 奖学金",
    intro: "LIFE Innoversity 奖学金并非自动提供。课程团队会根据资格及名额进行评估，并以书面方式确认。获批者实付 RM5,000.00。",
    sections: [
      ["课程费用包含什么", "无论支付标准费用或获得奖学金，课程均包括首三个月的三个现场课程、个人领导力诊断、导师辅导、学习工具、企业项目评审，以及随后三个月的 Chartered Manager 评估准备支持。CMI 的评估费及会员费由 CMI 独立收取，除非正式费用表明确列为已包含项目。"],
