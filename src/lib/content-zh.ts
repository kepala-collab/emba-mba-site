...
export const COMPARISON_ZH = [
  ...
  { k: "课程费用", them: "授予院校公布的学费及附加费用", us: "标准费用 RM10,000.00；符合资格的马来西亚申请者经评估及书面批准后，可获 RM4,000.00 LIFE Innoversity 奖学金，获批者实付 RM6,000.00" },
...
export const CORE_PAGES_ZH = {
  ...
  fees: {
    ...
    title: "标准费用 RM10,000.00；符合资格者可申请 RM4,000.00 奖学金",
    intro: "符合资格的马来西亚申请者可凭 RM4,000.00 LIFE Innoversity 奖学金将费用降至 RM6,000.00——须经资格与名额评估并以书面确认，并非自动提供。",
    sections: [
      ...
      ["马来西亚申请者费用", "标准费用 RM10,000.00。符合资格的马来西亚申请者经评估及书面批准后，可获 RM4,000.00 LIFE Innoversity 奖学金，并实付 RM6,000.00。奖学金视名额及资格而定，并非自动获得。"],
