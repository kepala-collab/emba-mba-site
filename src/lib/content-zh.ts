...
export const COMPARISON_ZH = [
  { k: "修读时间", them: "18–24 个月", us: "三个月：六个培训日，分三个每月课程完成" },
  ...
  { k: "修读形式", them: "按授予院校公布的学术课程时间表修读", us: "三个月内每月一次周末课程，学员可继续工作" },
...
export const CORE_PAGES_ZH = {
  ...
  programme: {
    eyebrow: "三个月高管 MBA · 英国 CMI 认可",
    title: "为经验丰富的在职管理者设计",
    intro: "三个月完成六个培训日、辅导及企业项目。学员可在继续工作的同时完成课程。符合条件的学员可另行咨询 Chartered Manager 后续发展路径。",
    sections: [
      ["三个月课程安排", "完成六个培训日、三个集中课程、企业项目及辅导。达到课程要求后，学员取得获 CMI 认可的 Executive MBA 课程证书。"],
