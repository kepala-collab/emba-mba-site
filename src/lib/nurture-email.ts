...
const ZH: Record<NurtureStepKey, StepCopy> = {
  ...
  day14: {
    ...
    paragraphs: [
      ...
      "但如果阻碍您做决定的只是一个未解答的问题——适合度、日期、费用、奖学金择优评估，或认可的含义与边界——一次简短沟通就能解决。无需付款，不构成报名承诺，也不会有后续压力。",
    ],
    ctaLabel: "预约课程咨询",
    ctaPath: "/zh/apply",
...
const MS: Record<NurtureStepKey, StepCopy> = {
  day3: {
    ...
    paragraphs: [
      ...
      "Jika mana-mana bahagian dalam panduan itu kurang jelas, itulah sebabnya perbincangan program wujud. Tiada pembayaran, tiada komitmen pendaftaran — hanya jawapan.",
    ],
    facts: [
...
const FOOTER = {
  ...
  zh: {
    statement:
      `面向未来商业领导力的 Executive MBA，由 CMI 颁发并认可。这是由 Asian Business Consulting 设计及授课的 ${FACTS.durationMonths} 个月专业发展课程。Right Dots Resources 是其市场推广机构，负责课程咨询与报名协调。`,
