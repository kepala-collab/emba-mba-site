...
export const COMPARISON_MS = [
  ...
  { k: "Yuran kursus", them: "Yuran pengajian dan caj tambahan yang ditetapkan institusi", us: "Yuran standard RM10,000.00; pemohon Malaysia yang layak boleh dipertimbangkan untuk biasiswa LIFE Innoversity, dengan sebarang anugerah dan yuran peserta disahkan secara individu dalam bentuk bertulis" },
...
export const CORE_PAGES_MS = {
  ...
  programme: {
    ...
    intro: "Enam hari latihan, bimbingan dan projek perniagaan diselesaikan dalam tempoh enam bulan. Peserta terus bekerja sepenuh masa sepanjang kursus. Peserta yang layak boleh bertanya secara berasingan tentang laluan lanjutan Chartered Manager.",
    sections: [
      ["Susunan kursus enam bulan", "Selesaikan enam hari latihan, tiga sesi intensif, projek perniagaan dan bimbingan. Peserta yang memenuhi keperluan kursus menerima sijil program Executive MBA yang diiktiraf CMI."],
  ...
  fees: {
    ...
    title: "Yuran standard RM10,000.00; biasiswa dinilai berdasarkan kelayakan",
    intro: "Pemohon Malaysia yang layak boleh dipertimbangkan untuk biasiswa LIFE Innoversity, tertakluk pada kekosongan, penilaian dan kelulusan bertulis. Sebarang anugerah dan yuran peserta berkenaan disahkan secara individu dalam bentuk bertulis; biasiswa tidak diberikan secara automatik.",
    sections: [
      ["Apa yang termasuk dalam yuran kursus", "Sama ada membayar yuran standard atau menerima biasiswa, kursus merangkumi tiga sesi bersemuka dalam tempoh enam bulan, diagnostik kepimpinan peribadi, bimbingan fasilitator, alat pembelajaran dan penilaian projek perniagaan. Chartered Manager ialah laluan pilihan yang berasingan dengan kelayakan, penilaian dan yuran tersendiri, dan tidak termasuk dalam yuran kursus yang diterbitkan."],
      ["HRD Corp", HRD_CORP_CLAIM_MS],
      ["Yuran untuk pemohon Malaysia", "Yuran standard ialah RM10,000.00. Pemohon Malaysia yang layak boleh dipertimbangkan untuk biasiswa LIFE Innoversity. Sebarang anugerah dan yuran peserta disahkan secara individu dalam bentuk bertulis selepas penilaian; biasiswa tertakluk pada kekosongan dan tidak automatik."],
  ...
  intakes: {
    ...
    intro: "Setiap kohort diselesaikan melalui tiga hujung minggu berjadual sepanjang program, merentasi tiga sesi. Pasukan kursus mengesahkan kekosongan kohort semasa membalas pertanyaan.",
    sections: [
      ...INTAKES.map((intake) => [
...
export const FAQS_MS = [
  ["Bagaimana kursus ini disusun?", "Kursus berlangsung enam bulan, merangkumi enam hari latihan, tiga sesi hujung minggu, bimbingan dan projek perniagaan. Peserta yang memenuhi keperluan kursus menerima sijil program Executive MBA yang diiktiraf CMI. Chartered Manager ialah laluan pilihan CMI dengan kelayakan, penilaian dan yuran tersendiri, dan tidak termasuk dalam kursus ini atau yuran yang diterbitkan."],
  ["Bolehkah saya menamatkan kursus sambil bekerja sepenuh masa?", "Boleh. Kursus awam Malaysia berjalan selama enam bulan dengan enam hari latihan yang ditetapkan. Peserta menamatkan kursus sambil terus bekerja, dan menyiapkan projek aplikasi berasaskan isu perniagaan semasa mereka. Semak semua tarikh sesi yang diterbitkan sebelum mendaftar."],
  ["Adakah ini kursus pendidikan eksekutif atau ijazah MBA akademik?", "Ini ialah Executive MBA dalam kepimpinan perniagaan masa hadapan, dianugerahkan dan disokong oleh CMI. Kursus enam bulan ini ialah program pembangunan profesional dan pendidikan eksekutif — bukan ijazah akademik bertauliah MQA atau kelayakan yang dikawal selia."],
