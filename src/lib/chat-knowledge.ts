...
- Private decision resources: /diagnostic is a non-predictive, no-data reflection; /resources/advancement-brief is a printable factual programme dossier; /resources contains the employer conversation guide and neutral decision checklist.
