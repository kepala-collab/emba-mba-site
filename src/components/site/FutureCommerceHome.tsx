...
const COPY = {
  ...
  ms: {
    ...
    factDays: "hari latihan dalam tiga sesi dipermudah cara",
      ...
      <section className="commerce-section commerce-experience" aria-labelledby="commerce-experience-title">
        <div className="wrap">
          ...
          <div className="commerce-experience-grid">
            ...
            <Reveal delay={55}><figure><Image src="/media/future-commerce/founder-atelier.webp" alt={copy.experienceLabels[1]} width={1920} height={1080} sizes="(max-width: 820px) 50vw, 34vw" /><figcaption><span className="mono">02</span><strong>{copy.experienceLabels[1]}</strong></figcaption></figure></Reveal>
            <Reveal delay={90}><figure><Image src="/media/future-commerce/community-commencement.webp" alt={copy.experienceLabels[2]} width={1920} height={1440} sizes="(max-width: 820px) 50vw, 34vw" /><figcaption><span className="mono">03</span><strong>{copy.experienceLabels[2]}</strong></figcaption></figure></Reveal>
          </div>
        </div>
      </section>
      ...
      <section id="recognition" className="commerce-section commerce-recognition">
        <div className="wrap">
          ...
          <div className="commerce-recognition-support">
            <figure className="commerce-recognition-photo"><Image src="/brand/community/graduation-cohort.webp" alt="Future Ready Executive MBA graduation cohort" width={894} height={596} sizes="(max-width: 820px) 100vw, 64vw" /><figcaption>{PROGRAMME_PROOF.graduationAttendance} {locale === "zh" ? "名毕业生出席首届毕业典礼。" : locale === "ms" ? "graduan menghadiri majlis graduasi pertama." : "graduates attended the inaugural graduation."}</figcaption></figure>
