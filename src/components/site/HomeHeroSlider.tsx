...
const SLIDES = [
  {
    ...
    poster: "/brand/abc-graduation-poster.webp",
    mobilePoster: "/brand/community/graduation-graduates-2.webp",
    position: "left 45%",
  ...
  },
  {
    ...
    body: "Join a practitioner-led programme completed by 154 graduates across 17 cohorts: 16 English cohorts and a Mandarin cohort.",
    action: "Meet the community",
    href: "/asian-business-consulting#abc-film",
    kind: "image" as const,
    src: "/brand/community/graduation-cohort.webp",
