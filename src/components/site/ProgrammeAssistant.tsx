...
const COPY = {
  en: {
    ...
    unavailable: "The assistant is unavailable right now. Please talk to Roy on WhatsApp.",
    security: "Security verification could not be completed. Please try again or talk to Roy on WhatsApp.",
    human: "Talk to Roy on WhatsApp",
    ...
    waMessage: "Hi Roy, I have a question about the Future Ready Executive MBA.",
  },
  zh: {
    open: "咨询课程助手",
    title: "课程资讯助手",
    ...
    unavailable: "课程助手暂时无法使用，请通过 WhatsApp 联系 Roy。",
    security: "无法完成安全验证，请重试或通过 WhatsApp 联系 Roy。",
    human: "通过 WhatsApp 联系 Roy",
    prompts: ["课程费用是多少？", "课程获得什么认可？", "这与一般 HRD Corp 培训有何不同？", "下一期何时开课？"],
    waMessage: "Roy 您好，我想咨询 Future Ready 高管 MBA。",
  },
} as const;
