...
const COPY = {
  en: {
    ...
    unavailable: "The assistant is unavailable right now. Please contact Future Ready EMBA on WhatsApp.",
    security: "Security verification could not be completed. Please try again or contact Future Ready EMBA on WhatsApp.",
    human: "Contact Future Ready EMBA on WhatsApp",
    prompts: ["What does the programme cost?", "How is it recognised?", "What does the CMI certificate represent?", "When is the next intake?"],
    waMessage: "Hello Future Ready EMBA team, I have a question about the programme.",
  },
  zh: {
    open: "咨询课程助手",
    title: "课程资讯助手",
    eyebrow: "经核实的课程资料",
    intro: "可查询课程形式、费用、开课日期、认可及资格条件，无需提供个人资料。",
    placeholder: "请输入课程问题…",
    send: "发送",
    sending: "正在整理…",
    close: "关闭课程助手",
    ...
    unavailable: "课程助手暂时无法使用，请通过 WhatsApp 联系 Future Ready Executive MBA。",
    security: "无法完成安全验证，请重试或通过 WhatsApp 联系 Future Ready Executive MBA。",
    human: "通过 WhatsApp 联系 Future Ready Executive MBA",
    prompts: ["课程费用是多少？", "课程获得什么认可？", "CMI 证书代表什么？", "下一期何时开课？"],
    waMessage: "您好，我想咨询 Future Ready Executive MBA。",
  },
  ms: {
    open: "Tanya pembantu program",
    title: "Pembantu program",
    eyebrow: "Fakta program yang disahkan",
    intro: "Tanya tentang format, yuran, tarikh pengambilan, pengiktirafan atau syarat kelayakan. Tiada butiran peribadi diperlukan.",
    ...
    prompts: ["Berapakah yuran program?", "Apakah pengiktirafan yang diterima?", "Apakah yang diwakili oleh sijil CMI ini?", "Bilakah pengambilan seterusnya?"],
