...
const COPY = {
  ...
  zh: {
    ...
    unavailable: "课程助手暂时无法使用，请通过 WhatsApp 联系 Future Ready 高管 MBA。",
    security: "无法完成安全验证，请重试或通过 WhatsApp 联系 Future Ready 高管 MBA。",
    human: "通过 WhatsApp 联系 Future Ready 高管 MBA",
