...
const T = {
  en: {
    ...
    conversationOptions: [
      ...
      ["whatsapp", "A WhatsApp conversation with Roy"],
    ...
    errors: {
      ...
      service: "The request service is temporarily unavailable. Your entries have been kept; submit again or talk to Roy on WhatsApp.",
    ...
    verifyErr: "The security check could not load. Refresh the page or talk to Roy on WhatsApp.",
    verifyFallback: "Talk to Roy on WhatsApp →",
  ...
  zh: {
    ...
    errors: {
      ...
      service: "请求服务暂时无法使用。您填写的内容已保留；请再次提交或通过 WhatsApp 联系 Roy。",
      network: "网络连接中断。您填写的内容已保留；请检查网络后再次提交。",
    },
    verify: "提交前请完成安全验证。您填写的内容已保留。",
    verifyErr: "安全验证无法加载。请刷新页面，或通过 WhatsApp 联系 Roy。",
    verifyFallback: "通过 WhatsApp 联系 Roy →",
    security: "安全验证",
