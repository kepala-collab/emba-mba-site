...
import { CTA_LABELS, ENQUIRY_COMMITMENT, FACTS, INTAKES, PROGRAMME_YEAR, SITE } from "@/lib/content";
...
const T = {
  en: {
    ...
    compactTitle: `Get the ${PROGRAMME_YEAR} programme guide.`,
    ...
    intents: [
      ["individual_self_funded", "For my own role", "I am considering the programme for myself."],
      ["employer_sponsored", "Employer sponsorship", "I want to use employer sponsorship or eligible HRD Corp funds."],
      ["employer_evaluating", "Manager development", "I am evaluating the programme for managers responsible for teams in my company."],
      ["international", "International participant", "I am enquiring from outside Malaysia."],
      ["mandarin", "Mandarin programme", "I want to discuss a Mandarin-language cohort."],
      ["details_first", "Programme information first", "Send the programme guide before arranging a call."],
    ] as const,
    ...
    submit: CTA_LABELS.submit, sending: "Sending securely…",
    ...
    fine: `Programme enquiry · ${ENQUIRY_COMMITMENT}`,
  ...
  zh: {
    ...
    compactKicker: "课程咨询",
    compactTitle: `索取 ${PROGRAMME_YEAR} 年课程指南。`,
    ...
    intents: [
      ["individual_self_funded", "个人发展", "我正在为自己考虑这项课程。"],
      ["employer_sponsored", "公司赞助", "我希望使用公司赞助或符合条件的 HRD Corp 资金。"],
      ["employer_evaluating", "管理人员发展", "我正在为公司中负责团队的管理人员评估这项课程。"],
      ["international", "国际学员", "我从马来西亚以外地区咨询。"],
      ["mandarin", "华语课程", "我想了解华语授课届别。"],
      ["details_first", "先收取课程资料", "先发送课程指南，再决定是否安排通话。"],
    ] as const,
    cohort: `首选 ${PROGRAMME_YEAR} 届别（选填）`,
    cohortOpen: "开放咨询",
    ...
    consentMarketing: "我愿意接收课程资讯与宣传通讯，可随时退订。",
    submit: CTA_LABELS.zh.submit, sending: "正在安全提交…",
    ...
    security: "安全验证",
    fine: `课程咨询 · ${ENQUIRY_COMMITMENT_ZH}`,
    campaignFine: "免费 PDF · 无需付款 · 不代表申请 · 可随时退订",
    okK: "沟通请求已收到",
    okH: (name: string) => `谢谢您${name ? `，${name}` : ""}。我们会按您的选择联系。`,
    okP: "课程团队将回复课程适合度、所选届别、雇主申请 HRD Corp 及奖学金资格。这项请求不等于录取、奖学金批准或付款承诺。",
  ...
  ms: {
    ...
    compactTitle: `Dapatkan panduan program ${PROGRAMME_YEAR}.`,
    compactIntro: `Beritahu kami keperluan anda terlebih dahulu. Pasukan program akan menghantar maklumat yang berkaitan serta tarikh ${PROGRAMME_YEAR} yang diterbitkan.`,
    ...
    intents: [
      ["individual_self_funded", "Untuk peranan saya sendiri", "Saya sedang mempertimbangkan program ini untuk diri sendiri."],
      ["employer_sponsored", "Tajaan majikan", "Saya ingin menggunakan tajaan majikan atau dana HRD Corp yang layak."],
      ["employer_evaluating", "Pembangunan pengurus", "Saya sedang menilai program ini untuk pengurus yang bertanggungjawab ke atas pasukan di syarikat saya."],
      ["international", "Peserta antarabangsa", "Saya membuat pertanyaan dari luar Malaysia."],
      ["mandarin", "Program Mandarin", "Saya ingin berbincang mengenai kohort berbahasa Mandarin."],
      ["details_first", "Maklumat program dahulu", "Hantarkan panduan program sebelum mengatur panggilan."],
    ] as const,
    cohort: `Kohort ${PROGRAMME_YEAR} pilihan (tidak wajib)`,
    cohortOpen: "Terbuka untuk pertanyaan",
    ...
    helper: "Kami menggunakan e-mel untuk mengesahkan pertanyaan ini dan menghubungi anda mengikut kaedah yang anda pilih.",
    ...
    submit: CTA_LABELS.ms.submit, sending: "Sedang dihantar dengan selamat…",
    ...
    errors: {
      ...
      rate_limit: "Rangkaian ini telah mencapai had penghantaran. Tunggu sepuluh minit, kemudian hantar semula pertanyaan yang sama.",
      service: "Perkhidmatan pertanyaan tidak tersedia buat sementara waktu. Maklumat anda telah disimpan; hantar semula atau hubungi Future Ready EMBA melalui WhatsApp.",
    ...
    fine: `Pertanyaan program · ${ENQUIRY_COMMITMENT_MS}`,
    campaignFine: "PDF percuma · Tiada bayaran · Bukan pendaftaran · Boleh berhenti melanggan bila-bila masa",
    okK: "Pertanyaan diterima",
    okH: (name: string) => `Terima kasih${name ? `, ${name}` : ""}. Kami akan menghubungi anda mengikut pilihan anda.`,
    okP: "Pasukan program akan membalas mengenai kesesuaian program, kohort pilihan anda, permohonan HRD Corp oleh majikan serta kelayakan biasiswa. Pertanyaan ini bukan pengesahan kemasukan, kelulusan biasiswa atau komitmen bayaran.",
