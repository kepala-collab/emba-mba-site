...
const UI_COPY = {
  ...
  ms: {
    ...
    guideBody: `Panduan Kemajuan ${PROGRAMME_YEAR} untuk Pengurus yang Bekerja menghimpunkan struktur program, tarikh, yuran, proses penilaian biasiswa dan pengiktirafan CMI dalam satu dokumen.`,
    restart: "Mula semula",
    back: "Kembali",
