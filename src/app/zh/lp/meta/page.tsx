...
export const metadata = {
  ...
  description:
    "专为在职领导者打造的英国 CMI 高管 MBA。3 个月周末授课，再进阶特许经理人。含奖学金 RM6,000 起，HRD Corp 可索赔。看看你是否符合资格。",
    ...
    <div lang="zh-Hans">
        ...
        <div className="wrap maxw-820" style={{ textAlign: "center" }}>
          ...
          <Reveal delay={120}>
            <p style={{ color: "var(--ink-2)", fontSize: "1.14rem", maxWidth: "46ch", margin: "24px auto 30px", lineHeight: 1.9 }}>
              一个由英国 CMI 认可的高管 MBA，为你重装顶尖领导者的思维方式 —— {FACTS.durationLong}，每月一个周末，无需暂停事业。没有论文，没有考试，还有一份属于你自己企业的转型方案。
            </p>
          </Reveal>
          <Reveal delay={160}>
      ...
      <section className="section" style={{ background: "var(--bg-2)" }}>
        <div className="wrap maxw-820">
          ...
          <Reveal className="mt-s"><p className="fine" style={{ marginTop: 26 }}>{FACTS.priceStd} → <b style={{ color: "#fff" }}>{FACTS.priceNet}</b>（含 RM4,000 马来西亚学员奖学金）· 100% HRD Corp 可索赔 · 提供分期付款。</p></Reveal>
        </div>
      </section>
