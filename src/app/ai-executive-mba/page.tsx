  ...
  return (
    <>
      ...
      <section className="section" style={{ paddingTop: "clamp(52px,7vw,84px)" }}>
        <div className="wrap">
          <Reveal><div className="eyebrow"><span className="l" /><span className="mono sec-k">AI-Ready Leadership · CMI (UK) Endorsed</span></div></Reveal>
          <Reveal delay={60}>
          ...
          <Reveal delay={120}>
            <p className="sec-sub" style={{ maxWidth: "58ch" }}>
              This is the same CMI (UK)-endorsed <Link href="/executive-mba" className="acc">Future-Ready Executive MBA</Link>, seen through an
      ...
      <section className="section" style={{ background: "var(--bg-2)" }}>
        <div className="wrap">
          ...
          <Reveal><h2 className="sec-h">An AI angle on a proven, CMI (UK)-endorsed programme.</h2></Reveal>
          <Reveal className="mt-m"><div className="grid-forces">
            {[
              ["CMI (UK)-endorsed", "A globally respected professional credential — not an MQA-regulated academic degree."],
              ["HRD Corp claimable", "Eligible Malaysian employers can claim the programme fee."],
              ["Format", FACTS.durationLong + " — one weekend a month, keep running your business."],
              ["Investment", FACTS.priceStd + " standard → " + FACTS.priceNet + " with the Malaysian scholarship."],
