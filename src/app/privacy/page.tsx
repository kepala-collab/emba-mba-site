...
export const metadata = {
  ...
  description:
    "How personal data submitted through this website is collected, used, shared and protected — in accordance with Malaysia's Personal Data Protection Act 2010 (PDPA).",
      ...
      <div className="wrap maxw-820">
        ...
        <div className="prose mt-m" style={{ marginLeft: 0 }}>
          ...
          <p>
            ...
            {OPERATOR.reg}) (&ldquo;we&rdquo;, &ldquo;us&rdquo;, &ldquo;our&rdquo;), an authorised marketing and
            enrolment partner for the Future Ready Executive MBA. We are responsible for personal data collected
          ...
          <ul>
            ...
            <li><strong>Technical data:</strong> page visited, referring website, campaign source (UTM parameters) and, via our hosting provider, your IP address and device/browser information.</li>
            <li><strong>Cookies &amp; analytics:</strong> we may use cookies and analytics tools to understand how the Site is used and to measure our marketing.</li>
          </ul>
