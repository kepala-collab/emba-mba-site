    ...
    <section className="section">
      <div className="wrap maxw-820">
        ...
        <div className="prose mt-m" style={{ marginLeft: 0 }}>
          ...
          <h2>不作结果保证</h2>
          <p>本网站不保证录取、HRD Corp 批准、就业、收入、晋升或任何商业成果。标准费用为 {FACTS.priceStd}；马来西亚学员获 {FACTS.scholarshipAmt} {FACTS.scholarshipProvider} 奖学金后实付 {FACTS.priceNet}。{HRD_CORP_CLAIM_ZH}</p>
          <h2>课程资讯助手</h2>
