  ...
  return (
    <>
      ...
      <article className="section"><div className="wrap prose">
        ...
        <h2>先想清要补强哪项能力</h2><p>把眼下亟需更高能力的那些决策、转型或责任，白纸黑字写下来。靠得住的课程会讲清教学方式、课堂内容与企业应用项目如何对上这个处境，而不会向您许诺升职、加薪或某个商业结果。</p>
        ...
        <h2>确认时间和费用您扛得起</h2><p>把开课的实际日期、出席要求、企业应用项目和全部费用，逐条摆到您现有的工作与家庭责任旁边比一比。一个您根本挤不出时间的安排，不会因为宣传话术漂亮就变得可行。</p>
        <blockquote>凭课程帮您练透的那份工作的成色来选，别凭那些承诺留下的空白来选。</blockquote>
