...
const COMPARISON = [
  ...
  ["修读时间", "有些以较短或模块化形式开办；每个提供者须公布自己的时间表。", `本课程为期 ${FACTS.durationLong}，六个月内分三个课程完成，共六个培训日。`],
        ...
        <section className="section">
          <div className="wrap maxw-820 prose">
            ...
            <p>
              ...
              课程在六个月内结合小组工作坊、辅导、战略决策框架及企业应用项目。学员在完成课程期间继续留任原有职位。
            </p>
            <p>
