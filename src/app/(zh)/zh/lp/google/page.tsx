...
const CMP = [
  ...
  ["投资", "标准费用 RM10,000.00；符合资格的马来西亚申请者可接受奖学金择优评估，任何奖学金金额及应付费用均会个别以书面确认", "授予院校公布的学费及附加费用"],
            ...
            <div>
              ...
              <Reveal delay={190}>
                <div className="lpg-stats" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 1, background: "var(--line)", marginTop: 24, borderRadius: 12, overflow: "hidden" }}>
                  {[["6 个月", "完整专业发展课程"], [FACTS.trainingDays + " 天", "分三个指定课程完成"], ["资格评估", "马来西亚申请者奖学金择优评估"]].map(([b, s]) => (
