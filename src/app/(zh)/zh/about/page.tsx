        ...
        <div className="wrap" style={{ maxWidth: 960 }}>
          <Reveal>
            <div className="card" style={{ padding: "clamp(24px,4vw,44px)" }}>
              ...
              <p className="fine" style={{ maxWidth: "62ch", marginTop: 18 }}>这门面向未来商业领导力的 Executive MBA 由 CMI 颁授并背书，是 Asian Business Consulting 设计并交付的 {FACTS.durationMonths} 个月专业发展课程。Right Dots Resources 是其市场推广机构，负责课程咨询与报名协调。已注册 HRD Corp 的马来西亚雇主须在开课前经 e-TRiS 递交 grant 申请；资格与批准金额由 HRD Corp 裁定。</p>
