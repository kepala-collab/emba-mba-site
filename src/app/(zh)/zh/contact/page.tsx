...
export const metadata = withSeo(path, {
  title: "联系 Future Ready 高管 MBA",
  description: "通过 WhatsApp、电话、电邮或在线表格联系 Future Ready 高管 MBA 课程团队，咨询课程资格、班次、学费及 HRD Corp。",
});
      ...
      <div className="wrap">
        <div className="contact-grid">
          <Reveal>
            ...
            <h1 className="sec-h">联系 Future Ready 高管 MBA</h1>
