...
const waText = encodeURIComponent("Roy 您好，我想咨询 Future Ready 高管 MBA（英国 CMI 认可课程）。");

export const metadata = withSeo(path, {
  title: "联系 Roy Affandi",
  description: "通过 WhatsApp、电话、电邮或在线表格联系课程协调员 Roy Affandi，咨询课程资格、班次、学费及 HRD Corp。",
});
      ...
      <div className="wrap">
        <div className="contact-grid">
          <Reveal>
            ...
            <h1 className="sec-h">直接联系 Roy Affandi</h1>
            ...
            <div className="mt-m" style={{ display: "grid", gap: 10 }}>
              ...
              <a className="btn btn-wa" href={`https://wa.me/${SITE.whatsapp}?text=${waText}`} target="_blank" rel="noopener" style={{ justifySelf: "start" }} data-track-event="contact_click" data-track-id="zh_contact_whatsapp" data-track-location="contact_page" data-contact-method="whatsapp" data-contact-language="zh">通过 WhatsApp 联系 Roy →</a>
            </div>
          </Reveal>
          <Reveal delay={100}>
