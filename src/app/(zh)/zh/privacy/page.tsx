...
export const metadata = withSeo(path, {
  title: "隐私政策",
  description: "说明本网站如何依据马来西亚个人资料保护法收集、使用、披露、保存及保护申请人与访客的个人资料。",
});
    ...
    <section className="section">
      <div className="wrap maxw-820">
        ...
        <div className="prose mt-m" style={{ marginLeft: 0 }}>
          ...
          <h2>用途与共享</h2>
          <p>资料用于回复咨询、评估课程适合度、处理报名、提供奖学金及 HRD Corp 指引、保障网站安全，以及在获得允许后分析网站表现。为完成这些用途，资料按需要提供给 {SITE.provider} 及负责托管、数据库、电子邮件、分析或通讯的受委托服务商；我们不会出售个人资料。</p>
          <h2>课程资讯助手</h2>
          <p>可选用的课程资讯助手会把课程问题及有限的近期对话内容发送给受委托的 AI 推理服务商，以依据经核实的课程资料生成答案。请勿输入姓名、电话、电邮、身份证或付款资料。本网站会在发送前拦截常见的联系及身份资料格式，不会把助手对话视为报名申请，也不会在本网站数据库储存对话记录。托管、安全防滥用及 AI 推理服务商会处理提供服务所需的安全与汇总使用资料。</p>
          <h2>储存、跨境处理与保留</h2>
          <p>服务商在马来西亚境外处理资料时，我们采取合理措施保障资料。资料仅在处理咨询、申请、业务及法律需要的期限内保存，之后删除或匿名化。</p>
          <h2>分析及隐私选择</h2>
          <p>必要储存用于安全及申请来源记录。可选分析工具仅在您选择允许后加载；本网站默认不加载广告像素。您可随时使用页尾的「隐私选择」更改决定。</p>
          <h2>您的权利</h2>
