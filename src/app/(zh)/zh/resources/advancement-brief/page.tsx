...
export const metadata = withSeo("/zh/resources/advancement-brief", {
  ...
  description: `可打印的课程指南，说明适合对象、${FACTS.durationMonths} 个月的课程结构、应用方法、马来西亚学员费用、CMI 认可与下一步。`,
});
