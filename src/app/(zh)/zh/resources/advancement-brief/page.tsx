  ...
  return (
    <div className="brief-shell">
      ...
      <article className="brief-document">
        ...
        <section className="brief-chapter"><span className="mono">05 / 费用</span><div><h2>标准费用与奖学金资格。</h2><div className="brief-facts"><div><strong>{FACTS.priceStd}</strong><span>标准课程费用</span></div><div><strong>资格评估</strong><span>马来西亚申请者奖学金评估</span></div><div><strong>书面确认</strong><span>奖学金金额及应付费用</span></div></div><p>奖学金视名额、评估及书面批准而定，并非自动获得。{HRD_CORP_CLAIM_ZH}</p></div></section>
