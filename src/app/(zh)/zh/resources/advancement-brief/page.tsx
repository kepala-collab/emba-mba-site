...
export const metadata = withSeo("/zh/resources/advancement-brief", {
  title: "高管进阶决策简报",
  description: "可打印的课程决策简报，说明适合对象、六个月结构、应用方法、马来西亚学员费用、CMI 认可边界及下一步。",
});
  ...
  return (
    <div className="brief-shell">
      ...
      <article className="brief-document">
        <header>
          <p className="mono sec-k">Working Scholar / 决策简报 01</p>
          <h1>高管进阶决策简报</h1>
        ...
        <section className="brief-chapter"><span className="mono">03 / 路径</span><div><h2>六个月，两项清楚边界。</h2><p>第一至第三个月为 Executive MBA 课程证书阶段。第四至第六个月为符合条件并选择参加者提供 CMI Chartered Manager 独立评估的准备支持。</p><p>CMI 决定 Chartered Manager 的申请资格、评估、会员、费用、授予及称号持续使用。CMgr MCMI 并非自动取得。</p></div></section>
