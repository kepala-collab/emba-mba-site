  ...
  return (
    <div className="brief-shell">
      ...
      <article className="brief-document">
        ...
        <section className="brief-chapter"><span className="mono">02 / 方法</span><div><h2>把有结构的探究应用到真实情境。</h2><p>六个月包含六个培训日、三个指定课程、实践者框架、诊断、辅导及企业应用项目。学习重点包括系统、证据、假设、选项及执行。</p><div className="brief-facts"><div><strong>6 天</strong><span>课程培训</span></div><div><strong>3 次</strong><span>按公布日期安排课程</span></div><div><strong>12 个</strong><span>应用框架模块</span></div></div></div></section>
        <section className="brief-chapter"><span className="mono">03 / 六个月安排</span><div><h2>六个月，完整课程。</h2><p>学员在六个月内完成三个指定课程、辅导及企业应用项目。达到课程要求后，获颁 CMI Certificate of Recognition。</p><p>Chartered Manager 是独立可选 CMI 路线，具有独立资格、评估、会员及费用，不包含在本课程或已公布费用内。</p></div></section>
        ...
        <section className="brief-chapter"><span className="mono">05 / 费用</span><div><h2>标准费用与奖学金资格。</h2><div className="brief-facts"><div><strong>{FACTS.priceStd}</strong><span>标准课程费用</span></div><div><strong>资格评估</strong><span>马来西亚申请者奖学金择优评估</span></div><div><strong>书面确认</strong><span>奖学金金额及应付费用</span></div></div><p>奖学金视名额、评估及书面批准而定，并非自动获得。{HRD_CORP_CLAIM_ZH}</p></div></section>
