  ...
  return (
    <div className="brief-shell">
      ...
      <article className="brief-document">
        ...
        <section className="brief-chapter"><span className="mono">04 / 认可</span><div><h2>{CERTIFICATE_POSITIONING.headline}</h2><p>课程具 CMI（英国）背书及认可状态。完成要求的学员获颁 CMI Certificate of Recognition。此证书记录专业课程完成，并非受监管资格或学术学位。</p></div></section>
