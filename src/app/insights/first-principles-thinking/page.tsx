...
export const metadata = {
  ...
  description:
    "How to reason from fundamental truths instead of copying competitors — a practical guide to first-principles thinking for strategy, with a simple 4-step method and business examples.",
};
...
const jsonLd = {
  ...
  description:
    "How to reason from fundamental truths instead of copying competitors — a practical guide to first-principles thinking for strategy, with a simple 4-step method and business examples.",
  author: { "@type": "Organization", name: "Asian Business Consulting" },
};
