    ...
    <section className="section">
      <div className="wrap maxw-820">
        ...
        <div className="prose mt-m" style={{ marginLeft: 0 }}>
          ...
          <p>Laman web ini dan borang pertanyaannya dikendalikan oleh <strong>{OPERATOR.name}</strong> (nombor pendaftaran {OPERATOR.reg}), yang bertindak sebagai agensi pemasaran <strong>{SITE.provider}</strong> bagi pertanyaan program, sebut harga dan penyelarasan pendaftaran. Program disediakan oleh <strong>{SITE.provider}</strong>; data permohonan dikongsi dengan pasukan programnya untuk memproses pertanyaan, penilaian kelayakan, permohonan dan pendaftaran.</p>
