  ...
  return (
    <>
      ...
      <section className="section chartered-positioning"><div className="wrap">
        <Reveal><div className="reading-section-head"><p className="mono sec-k">Nilai pengiktirafan ini</p><h2 className="sec-h">Bukti pembangunan profesional, bukan sekadar sijil kehadiran.</h2><p>Program ini menghubungkan pengiktirafan profesional CMI dengan projek aplikasi yang berakar pada situasi perniagaan peserta sendiri.</p></div></Reveal>
        <div className="chartered-outcome-grid">
          ...
          <Reveal delay={45}><article><span className="mono">02</span><h3>Bukti profesional yang boleh dijelaskan</h3><p>Sijil program dan projek aplikasi menjadi asas yang boleh dipercayai untuk menerangkan pembangunan pengurusan anda dalam profil profesional dan komunikasi kerjaya.</p></article></Reveal>
      ...
      <section className="section"><div className="wrap chartered-preparation-grid">
        <Reveal><div className="reading-section-head"><p className="mono sec-k">Nilai kepada perniagaan dan kerjaya</p><h2 className="sec-h">Bawa satu keputusan sebenar, dan bina cara membuat keputusan yang lebih mantap untuk keputusan seterusnya.</h2><p>Program ini membantu peserta mendiagnosis masalah dengan lebih tepat, membandingkan pilihan, menjelaskan asas keputusan dan memimpin pasukan untuk bertindak. Program tidak menjamin kenaikan pangkat, gaji, pekerjaan atau hasil perniagaan.</p></div><Link href="/ms/how-it-works" className="btn btn-ghost">Fahami kaedah program <span aria-hidden="true">→</span></Link></Reveal>
        <ol className="chartered-preparation-list"><li><span>01</span><div><h3>Diagnosis dahulu, keputusan kemudian</h3><p>Asingkan gejala, andaian dan kekangan sebelum sumber dilaburkan.</p></div></li><li><span>02</span><div><h3>Jelaskan asas keputusan</h3><p>Bandingkan pilihan dan terangkan mengapa satu arah wajar disokong.</p></div></li><li><span>03</span><div><h3>Terjemahkan pertimbangan kepada tindakan</h3><p>Bina pelan tindakan praktikal berdasarkan situasi perniagaan semasa anda.</p></div></li></ol>
      </div></section>
