    ...
    <section className="section">
      <div className="wrap maxw-820">
        ...
        <div className="prose mt-m" style={{ marginLeft: 0 }}>
          ...
          <p>Laman ini tidak menjamin kemasukan, biasiswa, kelulusan HRD Corp, pekerjaan, pendapatan, kenaikan pangkat atau sebarang hasil perniagaan. Yuran standard ialah {FACTS.priceStd}. Pemohon Malaysia yang layak boleh memohon biasiswa {FACTS.scholarshipProvider} sebanyak {FACTS.scholarshipAmount}; biasiswa tertakluk pada kekosongan, penilaian dan kelulusan bertulis. Pemohon yang diluluskan membayar {FACTS.priceAfterScholarship}. {HRD_CORP_CLAIM_MS}</p>
          ...
          <p>Apabila anda melanggan, meminta panduan program atau menghantar pertanyaan, anda bersetuju menerima maklumat program dan komunikasi pemasaran Future Ready Executive MBA daripada pasukan program (melalui e-mel; jika anda memberikan nombor telefon, anda juga boleh dihubungi melalui WhatsApp atau telefon). Anda boleh menarik balik persetujuan pada bila-bila masa melalui pautan berhenti melanggan dalam e-mel pemasaran atau dengan menghubungi <a href="mailto:support@futurereadymba.com">support@futurereadymba.com</a>; penarikan balik tidak menjejaskan balasan kami terhadap pertanyaan yang telah anda hantar. Data peribadi diproses menurut Akta Perlindungan Data Peribadi 2010 Malaysia (Akta 709) dan pindaannya.</p>
