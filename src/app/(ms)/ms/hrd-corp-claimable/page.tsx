...
const INCLUSIONS_MS = [
  { b: `${FACTS.trainingDays} hari latihan merentasi ${FACTS.liveSessions} sesi berpandu`, s: `Bengkel rangka kerja yang dikendalikan pengamal, mengikut tarikh yang telah diterbitkan sepanjang program ${FACTS.durationMonths} bulan.` },
