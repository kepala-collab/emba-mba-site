...
const HRD_FAQS = [
  ...
  },
  {
    ...
    a: `Yuran standard ialah ${FACTS.priceStd}. Pemohon Malaysia yang layak boleh menerima biasiswa ${FACTS.scholarshipProvider} ${FACTS.scholarshipAmount} selepas penilaian dan kelulusan bertulis. Penerima yang diluluskan membayar ${FACTS.priceAfterScholarship}. Pilihan bayaran individu disenaraikan di halaman Yuran.`,
  },
];
        ...
        <div className="wrap maxw-820">
          ...
          <Reveal>
            <p className="sec-sub">
              ...
              individu? Pemohon Malaysia yang layak boleh menerima biasiswa {FACTS.scholarshipProvider} {FACTS.scholarshipAmount} selepas penilaian dan kelulusan bertulis,
