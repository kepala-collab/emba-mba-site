  ...
  return (
    <div className="brief-shell">
      ...
      <article className="brief-document">
        ...
        <section className="brief-chapter"><span className="mono">03 / Susunan {FACTS.durationMonths} bulan</span><div><h2>{FACTS.durationMonths} bulan, program yang lengkap.</h2><p>Peserta menamatkan {FACTS.liveSessions} sesi berpandu, bimbingan dan projek amali perniagaan dalam tempoh {FACTS.durationMonths} bulan. Peserta yang memenuhi keperluan program menerima CMI Certificate of Recognition.</p><p>Chartered Manager ialah laluan CMI berasingan yang bersifat pilihan, dengan kelayakan, penilaian, keahlian dan yuran tersendiri; ia tidak termasuk dalam program ini atau yuran yang diterbitkan.</p></div></section>
