    ...
    <div className="brief-shell">
      ...
      <article className="brief-document">
        <header>
          ...
          <p>Penerangan program yang ringkas dan padat untuk pengurus yang sedang bekerja dan sedang menimbang keupayaan yang perlu dihasilkan oleh fasa pembangunan profesional seterusnya.</p>
        </header>
        ...
        <section className="brief-chapter"><span className="mono">02 / Kaedah</span><div><h2>Terapkan inkuiri berstruktur pada situasi sebenar.</h2><p>Enam bulan ini merangkumi enam hari latihan, tiga sesi berjadual, rangka kerja pengamal, diagnostik, bimbingan dan projek aplikasi perniagaan. Fokus pembelajaran meliputi sistem, bukti, andaian, pilihan dan pelaksanaan.</p><div className="brief-facts"><div><strong>6 hari</strong><span>Latihan program</span></div><div><strong>3 sesi</strong><span>Diatur sepanjang program</span></div><div><strong>12 modul</strong><span>Rangka kerja aplikasi</span></div></div></div></section>
