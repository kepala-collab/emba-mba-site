  ...
  return (
    <div className="brief-shell">
      ...
      <article className="brief-document">
        ...
        <section className="brief-chapter"><span className="mono">02 / Kaedah</span><div><h2>Gunakan cara berfikir yang tersusun pada situasi sebenar anda.</h2><p>Enam bulan ini merangkumi enam hari latihan, tiga sesi berpandu, rangka kerja pengamal, diagnostik, bimbingan dan projek amali perniagaan. Fokus pembelajaran meliputi sistem, bukti, andaian, pilihan dan pelaksanaan.</p><div className="brief-facts"><div><strong>6 hari</strong><span>Latihan program</span></div><div><strong>3 sesi</strong><span>Diatur sepanjang program</span></div><div><strong>12 modul</strong><span>Rangka kerja aplikasi</span></div></div></div></section>
        <section className="brief-chapter"><span className="mono">03 / Susunan enam bulan</span><div><h2>Enam bulan, program yang lengkap.</h2><p>Peserta menamatkan tiga sesi berpandu, bimbingan dan projek amali perniagaan dalam tempoh enam bulan. Peserta yang memenuhi keperluan program menerima CMI Certificate of Recognition.</p><p>Chartered Manager ialah laluan CMI berasingan yang bersifat pilihan, dengan kelayakan, penilaian, keahlian dan yuran tersendiri; ia tidak termasuk dalam program ini atau yuran yang diterbitkan.</p></div></section>
