  ...
  return (
    <div className="brief-shell">
      ...
      <article className="brief-document">
        ...
        <section className="brief-chapter"><span className="mono">02 / Kaedah</span><div><h2>Gunakan cara berfikir yang tersusun pada situasi sebenar anda.</h2><p>Enam bulan ini merangkumi enam hari latihan, tiga sesi berjadual, rangka kerja pengamal, diagnostik, bimbingan dan projek amali perniagaan. Fokus pembelajaran meliputi sistem, bukti, andaian, pilihan dan pelaksanaan.</p><div className="brief-facts"><div><strong>6 hari</strong><span>Latihan program</span></div><div><strong>3 sesi</strong><span>Diatur sepanjang program</span></div><div><strong>12 modul</strong><span>Rangka kerja aplikasi</span></div></div></div></section>
        <section className="brief-chapter"><span className="mono">03 / Susunan enam bulan</span><div><h2>Enam bulan, program yang lengkap.</h2><p>Peserta menamatkan tiga sesi berjadual, bimbingan dan projek amali perniagaan dalam tempoh enam bulan. Peserta yang memenuhi keperluan program menerima CMI Certificate of Recognition.</p><p>Chartered Manager ialah laluan CMI berasingan yang bersifat pilihan, dengan kelayakan, penilaian, keahlian dan yuran tersendiri; ia tidak termasuk dalam program ini atau yuran yang diterbitkan.</p></div></section>
        <section className="brief-chapter"><span className="mono">04 / Pengiktirafan</span><div><h2>{CERTIFICATE_POSITIONING.headline}</h2><p>Executive MBA dalam kepimpinan perniagaan masa hadapan dianugerahkan dan disokong oleh CMI. Peserta yang memenuhi keperluan menerima CMI Certificate of Recognition. Sijil ini merekodkan penamatan program profesional; ia bukan kelayakan yang dikawal selia atau ijazah akademik.</p></div></section>
        <section className="brief-chapter"><span className="mono">05 / Yuran</span><div><h2>Yuran standard dan kelayakan biasiswa.</h2><div className="brief-facts"><div><strong>{FACTS.priceStd}</strong><span>Yuran standard program</span></div><div><strong>Kelayakan</strong><span>Penilaian biasiswa untuk pemohon Malaysia</span></div><div><strong>Bertulis</strong><span>Anugerah dan yuran peserta</span></div></div><p>Biasiswa terhad dan dianugerahkan secara terpilih selepas penilaian dan kelulusan bertulis — ia tidak diberikan secara automatik. {HRD_CORP_CLAIM_MS}</p></div></section>
        <section className="brief-chapter"><span className="mono">06 / Keputusan</span><div><h2>Sahkan perkara ini sebelum mendaftar.</h2><ul><li>Isu perniagaan sebenar yang mana akan saya bawa ke dalam projek amali perniagaan?</li><li>Bolehkah saya menghadiri sesi yang diterbitkan dan menyiapkan keperluan projek?</li><li>Adakah saya jelas tentang sifat dan sempadan sijil program?</li><li>Jika saya mahu meneruskan permohonan Chartered Manager, adakah saya faham penilaian dan yuran berasingan CMI?</li><li>Jika dibiayai majikan, siapa yang bertanggungjawab mengemukakan permohonan HRD Corp sebelum program bermula?</li></ul></div></section>
