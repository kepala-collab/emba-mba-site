  ...
  return (
    <>
      ...
      <article className="section"><div className="wrap prose">
        ...
        <h2>Kenal pasti dahulu keupayaan yang anda perlukan</h2><p>Tuliskan dengan jelas keputusan, perubahan atau tanggungjawab yang kini menuntut lebih daripada anda. Program yang boleh dipercayai akan menerangkan bagaimana kaedah pengajaran, isi sesi dan projek gunaannya berkait dengan situasi sebenar ini — tanpa menjanjikan kenaikan pangkat, pendapatan atau hasil perniagaan.</p>
