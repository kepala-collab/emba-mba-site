        ...
        <div className="wrap">
          ...
          <Reveal className="mt-m"><div className="grid-forces">
            {[
              ...
              ["Investment", FACTS.priceStd + " standard. Eligible Malaysian applicants may be considered, on a selective basis, for a LIFE Innoversity scholarship; any award and resulting participant fee are confirmed individually in writing."],
