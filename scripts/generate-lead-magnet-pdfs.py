...
decision = cover("A PRIVATE DECISION GUIDE", "Is This Programme Right for You?", "A plain-English guide for Malaysian managers who want to make a better next move - without stepping away from work.", "A clear view of the programme, the CMI-recognised programme certificate, the separate Chartered Manager route, time commitment and the questions to ask before you enquire.", "Use this guide to decide whether the programme fits the responsibility you carry now - not just the title you would like next.")
decision += [P("Start with the work you already carry.", "H1"), P("The programme is designed for business owners, directors, general managers and senior managers who need a more structured way to examine decisions, test assumptions and move an important business issue forward."), card("Six-month programme", "Six training days across three scheduled sessions, coaching and applied project work are completed across the full programme."), Spacer(1, 6*mm), card("Successful completion", "Participants who meet the programme requirements receive the CMI-recognised Executive MBA programme certificate. Chartered Manager remains a separate optional CMI route."), Spacer(1, 8*mm), P("A good fit if you:", "H2"), P("• already make decisions that affect people, operations or business performance<br/>• can bring a live business challenge into the learning<br/>• want applied management development rather than a traditional academic MBA<br/>• can protect time for three scheduled sessions, coaching and project work across six months"), Spacer(1, 4*mm), notice("What it is not: a university degree, an MQA-accredited academic MBA, a promise of promotion, or an automatic Chartered Manager award."), PageBreak()]
decision += [P("Ask these before you apply.", "H1"), card("1. Is the work relevant?", "Choose a current decision, constraint or opportunity that matters to your role or business."), Spacer(1, 4*mm), card("2. Is the schedule workable?", "The six-month programme uses three scheduled sessions, coaching and applied project work. Review the published cohort dates against your responsibilities."), Spacer(1, 4*mm), card("3. Do you need employer support?", "If funding or sponsorship matters, ask for the employer conversation and HRD Corp briefing before your company applies."), Spacer(1, 4*mm), card("4. Are you evaluating scholarship eligibility?", "Eligible Malaysian applicants may be considered for a LIFE Innoversity scholarship, subject to availability, assessment and written approval."), Spacer(1, 9*mm), cta(f"Request a no-obligation programme-fit conversation: {EMAIL}"), Spacer(1, 6*mm), notice("Published Malaysian standard fee: RM10,000.00. Any scholarship award and resulting participant fee are confirmed individually in writing. This guide does not constitute an offer of admission, scholarship approval or payment commitment.")]
