...
DOCS["decision"] = {
 "en": {
  ...
  "blocks": [
   ...
   ("card", "4.  Are you exploring the scholarship?", "A limited number of LIFE Innoversity scholarships are awarded on a selective basis to eligible Malaysian applicants, after assessment and written approval. They are never automatic."),
   ("sp", 5),
   ("h1", "Common questions."),
   ("faq", [
 ...
 "ms": {
  ...
  "blocks": [
   ...
   ("card", "4.  Menilai biasiswa?", "Bilangan biasiswa LIFE Innoversity yang terhad dianugerahkan secara terpilih kepada pemohon Malaysia yang layak, selepas penilaian dan kelulusan bertulis. Ia tidak pernah automatik."),
   ("sp", 5),
   ("h1", "Soalan lazim."),
   ("faq", [
 ...
 "zh": {
  ...
  "blocks": [
   ...
   ("card", "4.  正在评估奖学金？", "LIFE Innoversity 奖学金名额有限，仅择优授予符合资格的马来西亚申请者，须经评估与书面批准，绝非自动。"),
   ("sp", 5),
   ("h1", "常见问题。"),
   ("faq", [
...
DOCS["scholarship"] = {
 "en": {
  ...
  "intro": "Scholarships are limited and awarded on a selective basis. Eligibility is assessed, and an award exists only once it has been confirmed in writing. Knowing that up front makes your conversation with the programme team faster and clearer.",
  ...
  "blocks": [
   ...
   ("card", "LIFE Innoversity scholarship", "A limited number are awarded on a selective basis to eligible Malaysian applicants, after assessment and written approval."),
   ...
   ("h1", "Common questions."),
   ("faq", [
     ("Do all Malaysians get the scholarship?", "No. A limited number are awarded on a selective basis to eligible Malaysian applicants, after assessment and written approval. It is not automatic and is not a discount code."),
 ...
 "ms": {
  ...
  "blocks": [
   ...
   ("card", "Biasiswa LIFE Innoversity", "Bilangan yang terhad dianugerahkan secara terpilih kepada pemohon Malaysia yang layak, selepas penilaian dan kelulusan bertulis."),
   ...
   ("h1", "Soalan lazim."),
   ("faq", [
     ("Adakah semua rakyat Malaysia mendapat biasiswa?", "Tidak. Bilangan yang terhad dianugerahkan secara terpilih kepada pemohon Malaysia yang layak, selepas penilaian dan kelulusan bertulis. Ia tidak automatik dan bukan kod diskaun."),
 ...
 "zh": {
  ...
  "promise_t": "您将获得",
  "promise": "标准费用、奖学金择优评估条件、值得准备的问题、对沟通有帮助的事实，以及资格讨论的下一步。",
  "subhead": "清晰的条款保护各方。",
  "intro": "奖学金名额有限，仅择优授予。资格需经评估，且只有在书面确认后才存在奖学金。事先了解这一点，能让您与课程团队的沟通更快、更清晰。",
  "cover_cta": f"咨询奖学金择优评估 — {EMAIL}",
  "cover_notice": "Future Ready Executive MBA 是一项获 CMI（英国）认可的专业发展课程。它并非 MQA 认证的学术学位或受监管资格。",
  "blocks": [
   ("h1", "已公布的马来西亚费用。"),
   ("card", "标准课程费用", "RM10,000.00"),
   ("card", "LIFE Innoversity 奖学金", "名额有限，仅择优授予符合资格的马来西亚申请者，须经评估与书面批准。"),
   ...
   ("h1", "常见问题。"),
   ("faq", [
     ("所有马来西亚人都能获得奖学金吗？", "不是。名额有限，仅择优授予符合资格的马来西亚申请者，须经评估与书面批准。它并非自动，也不是折扣码。"),
