...
GUIDES = {
    ...
    "ms": {
        ...
        "sections": [
            ...
            ("Pengiktirafan yang dinyatakan dengan tepat", "Peserta yang berjaya menerima CMI Certificate of Recognition bagi program ini. Ini ialah program pembangunan profesional, bukan ijazah akademik terakreditasi MQA atau kelayakan yang dikawal selia. Chartered Manager ialah laluan pilihan CMI yang berasingan dengan kelayakan, penilaian, keahlian dan yuran tersendiri."),
