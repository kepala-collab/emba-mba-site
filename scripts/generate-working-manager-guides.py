...
GUIDES = {
    "en": {
        ...
        "sections": [
            ...
            (
                ...
                "The standard programme fee is RM10,000.00. Eligible Malaysian applicants may receive a RM4,000.00 LIFE Innoversity scholarship after assessment and written approval. An approved scholarship recipient pays RM6,000.00. The scholarship is not automatic and remains subject to availability.",
            ),
            (
                "Employer funding",
    ...
    "ms": {
        ...
        "sections": [
            ...
            ("Yuran peserta Malaysia", "Yuran standard program ialah RM10,000.00. Pemohon Malaysia yang layak boleh menerima biasiswa LIFE Innoversity RM4,000.00 selepas penilaian dan kelulusan bertulis. Penerima biasiswa yang diluluskan membayar RM6,000.00. Biasiswa tidak automatik dan tertakluk pada kekosongan."),
    ...
    "zh": {
        ...
        "sections": [
            ...
            ("马来西亚学员费用", "课程标准费用为 RM10,000.00。符合资格的马来西亚申请者经评估及书面批准后，可获 RM4,000.00 LIFE Innoversity 奖学金。获批准的奖学金受惠者支付 RM6,000.00。奖学金并非自动获得，并视名额而定。"),
    ...
    (
        "ms",
        {
            **GUIDES["ms"],
            ...
            "lead": "Yuran standard ialah RM10,000.00. Biasiswa LIFE Innoversity RM4,000.00 hanya untuk pemohon Malaysia yang layak, tertakluk pada kekosongan, penilaian dan kelulusan bertulis.",
    ...
    (
        "zh",
        {
            **GUIDES["zh"],
            ...
            "lead": "标准课程费用为 RM10,000.00。RM4,000.00 LIFE Innoversity 奖学金只提供给符合资格的马来西亚申请者，并视名额、评估及书面批准而定。",
            "cta": "咨询奖学金评估流程",
        },
    ),
]
