...
const banned = [
  ...
  ["stale fee", /RM\s*5,?000(?:\.00)?/i],
  ["public scholarship amount", /RM\s*4,?000(?:\.00)?/i],
  ["public post-scholarship fee", /RM\s*6,?000(?:\.00)?/i],
  ["retired three-month programme", /\b(?:three[- ]month|3[- ]month|first three months|months four to six|three further months|next three months|certificate phase|programme-certificate phase)\b/i],
  ["retired Chinese three-month programme", /(?:三个月|3\s*个月|第四至第六|课程证书阶段|CMgr\s*申请准备|3\s*\+\s*3)/i],
...
const required = [
  ...
  'Any award and resulting participant fee are confirmed individually in writing.',
  'trainingDays: "6"',
  'liveSessions: "3"',
  'moduleCount: "12"',
